...
/* Generated from ../O.Common/depo.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devaiStream, *pvar_dset_devAiStats, *pvar_dset_devAiClusts,
    ...
    *pvar_dset_asynLiUInt32Digital, *pvar_dset_devlonginStream,
    ...
    *pvar_dset_devstringinStream, *pvar_dset_devStringinStats,
...
static const char * const deviceSupportNames[] = {
    ...
    "devaiStream", "devAiStats", "devAiClusts", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "asynAoInt32", "asynAoFloat64",
    "devaoStream", "devAoStats", "asynRecordDevice", "devBiSoft",
    ...
    "asynBoInt32", "asynBoUInt32Digital", "devboStream", "devBusySoft",
    ...
    "devPrintfStdio", "devsCalcoutSoft", "devscalcoutStream", "devSiSoft",
    "devSiSoftCallback", "devTimestampSI", "devSiGeneralTime",
    "devSiEnviron", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
    "asynSiOctetRead", "devstringinStream", "devStringinStats",
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_modbusInterposeRegister, pvar_func_save_restoreRegister,
...
int depo_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/depo";
...
/* depo_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"depo_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    depo_registerRecordDeviceDriver(*iocshPpdbbase);
}
