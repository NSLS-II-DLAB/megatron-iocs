...
/* Generated from ../O.Common/bk1787b.dbd */
...
int bk1787b_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/bk1787b";
...
/* bk1787b_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"bk1787b_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    bk1787b_registerRecordDeviceDriver(*iocshPpdbbase);
}
