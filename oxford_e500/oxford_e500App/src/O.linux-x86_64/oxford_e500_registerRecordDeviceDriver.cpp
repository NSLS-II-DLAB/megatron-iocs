...
/* Generated from ../O.Common/oxford_e500.dbd */
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_iocshSystemCommand, pvar_func_save_restoreRegister,
...
int oxford_e500_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/epics/iocs/oxford_e500";
...
/* oxford_e500_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"oxford_e500_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    oxford_e500_registerRecordDeviceDriver(*iocshPpdbbase);
}
