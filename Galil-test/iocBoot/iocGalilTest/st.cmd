...
dbpf("Test{DMC:1}LIMITTYPE_CMD", 1)
dbpf("Test{DMC:1}A_HOMEALLOWED_CMD",3)
dbpf("Test{DMC:1}A_USWITCH_CMD",1)
dbpf("Test{DMC:1}A_JAH_CMD",0)
dbpf("Test{DMC:1}A_OFFONERR_CMD",1)
#dbpf("Test{DMC:1}A.NTM",0)
# end
