...
static const char * const recordTypeNames[] = {
    ...
    "printf", "scalcout", "scanparm", "sel", "seq", "sscan", "sseq",
    "state", "stringin", "stringout", "sub", "subArray", "swait",
    "transform", "waveform"
};
...
static const char * const deviceSupportNames[] = {
    ...
    "devsCalcoutSoft", "devSiSoft", "devSiSoftCallback", "devTimestampSI",
...
epicsShareExtern reg_func pvar_func_GalilSupportRegister,
...
int GalilTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/epics/iocs/Galil";
    ...
    runRegistrarOnce(pvar_func_GalilSupportRegister);
...
/* GalilTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"GalilTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(GalilTest_registerRecordDeviceDriver(*iocshPpdbbase));
}
