...
static const char * const deviceSupportNames[] = {
    ...
    "devPrintfStdio", "devscalcoutStream", "devSiSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devPrintfStdio, pvar_dset_devscalcoutStream,
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_dbndInitialize, pvar_func_streamRegistrar,
...
int depo_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/epics/iocs/test";
