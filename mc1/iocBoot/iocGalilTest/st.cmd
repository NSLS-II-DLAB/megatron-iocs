...
dbpf("Depo{MC:1}LIMITTYPE_CMD", 1)
dbpf("Depo{Ax:1}Mtr_HOMEALLOWED_CMD",3)
dbpf("Depo{Ax:1}Mtr_USWITCH_CMD",1)
dbpf("Depo{Ax:1}Mtr_JAH_CMD",0)
dbpf("Depo{Ax:1}Mtr_OFFONERR_CMD",1)
#dbpf("Depo{Ax:1}Mtr.NTM",0)
# end
