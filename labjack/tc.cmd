# LabJack_T7.cmd
epicsEnvSet("N"			,2)
epicsEnvSet("IP_ADDRESS"	,"192.168.100.61")
...
drvModbusAsynConfigure("LJT7_$(N)_AI_In",        "LJT7_$(N)",   1,     3,        7012,   6,    FLOAT32_BE,  100, "LJT7_module")
#drvModbusAsynConfigure("LJT7_$(N)_AI_In",        "LJT7_$(N)",   1,     3,        7016,   2,    FLOAT32_BE,  100, "LJT7_module")
...
#drvModbusAsynConfigure("LJT7_$(N)_AIRes", 	  "LJT7_$(N)",   0,     6,    41500,   14,        UINT16,    1, "LJT7_module")

# Set 2 primary analog outputs.
#drvModbusAsynConfigure("LJT7_$(N)_AO",           "LJT7_$(N)",   0,    16,     1000,    4,    FLOAT32_BE,    1, "LJT7_module")

#dbLoadTemplate("depo-ljt7-$(N).substitutions")

dbLoadRecords("db/tc.db")
